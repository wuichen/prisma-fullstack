 ...
 */
export default ({ as, to, onClick, text, color = 'white', isSubmitting }: ButtonArrowProps) => (
  <ArrowButton as={as} to={to} onClick={onClick} color={color} role="button" data-a11y="false">
    {isSubmitting ? (
      <Spinner />
    ) : (
...
export const ArrowRightIcon = ({ fill = 'white' }) => (
  <svg width="35" height="7" viewBox="0 0 35 7" version="1.1">
    <g fill="none">
      <g>
        <path d="M 3.5 0L 6.53109 5.25L 0.468911 5.25L 3.5 0Z" transform="matrix(0 1 -1 0 35 0)" fill={fill} />
        <line y1="-0.5" x2="30" y2="-0.5" transform="translate(0 4)" stroke={fill} />
      </g>
    </g>
  </svg>
);
