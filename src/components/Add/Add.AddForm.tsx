    ...
    <Section>
      {submitted ? (
        <SubmittedScreen>
          ...
          <SubmittedText>A member of the Narative team will be in touch with you soon.</SubmittedText>
          <SubmittedBackButton onClick={toggleAdd}>Go back</SubmittedBackButton>
          <SocialLinksContainer>
            <SocialLinks fill="black" />
          </SocialLinksContainer>
          <CopyRightContainer>© {new Date().getFullYear()} Narative Studio Inc.</CopyRightContainer>
        </SubmittedScreen>
      ) : (
        <Formik
            ...
            return (
              <StyledFormikForm>
                ...
                <ButtonContainer animation={animation} delay={baseDelay + 610}>
                  <ButtonArrow isSubmitting={props.isSubmitting} color="black" type="submit" text="Send to narative" />
                </ButtonContainer>
                <MobileButtonContainer animation={animation} delay={baseDelay + 610}>
                  <Button isSubmitting={props.isSubmitting} text="Send to narative" />
    ...
    <ContactWithEmail animation={animation} delay={delay}>
      <ContactWithEmailText>
        <CopyToClipboard copyOnClick="careers@narative.co" iconFill="rgba(0,0,0,0.3)">
          ...
          <button>
            careers@narative.co <Hidden>Copy careers@narative.co go clipboard.</Hidden>
          </button>
        </CopyToClipboard>
      </ContactWithEmailText>
    </ContactWithEmail>
