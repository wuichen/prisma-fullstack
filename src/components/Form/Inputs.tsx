...
import { useEnum, useModel } from '../../library/hooks/useSchema'
...
export const EnumInput: React.FC<InputProps> = ({
  field,
  value,
  error,
  register,
...
export const ObjectInput: React.FC<InputProps> = ({
  field,
  value,
  error,
  register,
  ...
  const [getData, { data, loading }] = useLazyQuery(
    generated[`FindOne${field.type}Document` as keys] as any,
  )
...
export const BooleanInput: React.FC<InputProps> = ({
  field,
  value,
  register,
  setValue,
