...
const SelectOptionContainer = styled.div`
  ...
  border-radius: 3px;
  padding: 0.6rem 0px;
  box-shadow: rgba(99, 114, 130, 0.12) 0px 0px 0px 1px, rgba(27, 39, 51, 0.16) 0px 8px 16px;
`;
...
const SelectArrow = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="12" height="6" viewBox="0 0 10 5">
    <g fill="none" fillRule="evenodd">
      <path stroke="#000" strokeOpacity=".008" strokeWidth="0" d="M-7-10h24v24H-7z" />
...
class Select extends Component {
  ...
  render() {
    ...
    return (
      <OutsideClickHandler onOutsideClick={() => this.setState({ isOpened: false })}>
        <InputContainer onClick={(event) => this.toggleSelectDropdown(event)}>
          <SelectBorder>
            ...
            <LabelAnimation>
              {selectedValue && <StyledLabel selectedValue={selectedValue}>{selectedValue}</StyledLabel>}
            </LabelAnimation>
            <SelectArrowButton
              type="button"
              tabIndex="0"
