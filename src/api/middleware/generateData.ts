...
// when private model request comes from user, it will come with a where query
// when private model request comes from user, it wont come with a where query, we should generate for them
