...
import useOnClickOutside from 'landings/common/src/hooks/useOnClickOutside';
import NavbarWrapper, { MenuArea, MobileMenu, Search } from './navbar.style';
import LogoImage from 'landings/common/src/assets/image/cryptoModern/logo-white.png';
import LogoImageAlt from 'landings/common/src/assets/image/cryptoModern/logo.png';

import { navbar } from 'landings/common/src/data/CryptoModern';
...
const Navbar = () => {
  ...
  return (
    <NavbarWrapper className="navbar">
      <Container>
        <Logo href="/cryptoModern" logoSrc={LogoImage} title="Crypto Modern" className="main-logo" />
        <Logo href="/cryptoModern" logoSrc={LogoImageAlt} title="Crypto Modern" className="logo-alt" />
        {/* end of logo */}
