...
import FooterWrapper, { List, ListItem, CopyrightText, SocialList, SelectWrapper } from './footer.style';

import LogoImage from 'landings/common/src/assets/image/charity/logo.svg';
import { menuWidgets, socialLinks } from 'landings/common/src/data/Charity';
