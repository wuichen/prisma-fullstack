...
import SectionWrapper, { SectionHeader, TitleArea, LinkArea, Text, PostArea } from './blogSection.style';

import { posts } from 'landings/common/src/data/Charity';
      ...
      <Container width="1260px">
        <SectionHeader>
          <TitleArea>
            ...
            <Text>
              People around the world are raising money for what they are passionate about. Get The Latest PayBear
              Updates
              <Link href="#1">
