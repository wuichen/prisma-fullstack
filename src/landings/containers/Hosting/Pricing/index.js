...
import Switch from 'landings/common/src/components/Switch';
...
import { MONTHLY_PRICING_TABLE, YEARLY_PRICING_TABLE } from 'landings/common/src/data/Hosting/data';
      ...
      <Container>
        <Box {...secTitleWrapper}>
          <Fade bottom cascade>
            ...
            <Heading {...secHeading} content="What’s our monthly pricing subscription" />
            <SwitchWrapper>
              <Switch
