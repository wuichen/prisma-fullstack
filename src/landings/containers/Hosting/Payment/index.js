...
import CardImage from 'landings/common/src/assets/image/hosting/pay-card.png';
import PayLogos from 'landings/common/src/assets/image/hosting/pay-logo.png';
    ...
    <Box {...sectionWrapper}>
      <Container>
        <Box {...row}>
          <Box {...col} {...textArea}>
            <Fade bottom cascade>
              <Heading {...title} content="We have supported all payment gateways on domain hosting" />
              <Text
                {...description}
