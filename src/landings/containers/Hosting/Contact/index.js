...
const ContactSection = ({ sectionWrapper, row, contactForm, secTitleWrapper, secHeading, secText, button, note }) => {
  return (
    <Box {...sectionWrapper}>
      <Container>
        <Box {...secTitleWrapper}>
          <Text {...secText} content="CONTACT US" />
          <Heading {...secHeading} content="Are you Interested to meet with us?" />
        </Box>
        <Box {...row}>
          <Box {...contactForm}>
            <ContactFromWrapper>
