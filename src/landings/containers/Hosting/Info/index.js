...
import ImageOne from 'landings/common/src/assets/image/hosting/info1.png';
import ImageTwo from 'landings/common/src/assets/image/hosting/info2.png';
    ...
    <Box {...sectionWrapper}>
      <Container>
        <Box {...row}>
          <Box {...col} {...textArea}>
            <Fade bottom cascade>
              <Heading {...title} content="Increase your website growth with high performance servers" />
              <Text
                {...description}
