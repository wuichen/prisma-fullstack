...
import BannerWrapper, { SearchWrapper, List, DiscountWrapper, DiscountLabel } from './banner.style';

import { search } from 'react-icons-kit/feather/search';

import { DOMAIN_NAMES, DOMAIN_PRICE } from 'landings/common/src/data/Hosting/data';

const BannerSection = ({ row, title, description, button, textArea, searchArea, discountAmount, discountText }) => {
  return (
          ...
          <Box {...textArea}>
            <DiscountWrapper>
              <DiscountLabel>
                ...
                <Text {...discountText} content="on every first annual purchase" />
              </DiscountLabel>
            </DiscountWrapper>
            <Heading {...title} content="The best webhosting starting at $12.98/month" />
            <Text
              {...description}
