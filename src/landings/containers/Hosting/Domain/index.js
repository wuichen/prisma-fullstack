...
import Domains from 'landings/common/src/assets/image/hosting/circle.png';

const DomainSection = ({ sectionWrapper, row, col, title, description, button, textArea, imageArea }) => {
  return (
    <Box {...sectionWrapper}>
      <Container>
        <Box {...row}>
          ...
          <Box {...col} {...textArea}>
            <Fade bottom cascade>
              <Heading {...title} content="Available domain extension with your custom name" />
              <Text
                {...description}
