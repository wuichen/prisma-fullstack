...
import GuaranteeImage from 'landings/common/src/assets/image/hosting/badge.png';

const GuaranteeSection = ({ sectionWrapper, row, title, description, textArea, imageArea, ImageOne }) => {
  return (
    <Box {...sectionWrapper}>
      <Container>
        <Box {...row}>
