...
import { FEATURES_DATA } from 'landings/common/src/data/Hosting/data';

import ShapeOne from 'landings/common/src/assets/image/hosting/shape-1.svg';
import ShapeTwo from 'landings/common/src/assets/image/hosting/shape-2.svg';
import ShapeThree from 'landings/common/src/assets/image/hosting/shape-3.svg';
import ShapeFour from 'landings/common/src/assets/image/hosting/shape-4.svg';
import ShapeFive from 'landings/common/src/assets/image/hosting/shape-5.svg';
      ...
      <Container>
        <Box {...secTitleWrapper}>
          <Fade bottom cascade>
            ...
            <Heading {...secHeading} content="Our Featured Service that We Provide" />
          </Fade>
        </Box>
            ...
            <Box {...col} key={`feature-${index}`}>
              {featureItem.animation ? (
                <Fade bottom delay={index * 120}>
                  <FeatureItem
                    title={<Heading {...featureItemHeading} content={featureItem.title} />}
                    description={<Text {...featureItemDes} content={featureItem.description} />}
