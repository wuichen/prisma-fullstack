...
import data from 'landings/common/src/data/Agency';

import GroupImage1 from 'landings/common/src/assets/image/agency/group/group-image1.jpg';
import GroupImage2 from 'landings/common/src/assets/image/agency/group/group-image2.jpg';
import GroupImage3 from 'landings/common/src/assets/image/agency/group/group-image3.jpg';

const AboutUsSection = ({ row, col, title, description, textArea, featureTitle, btnStyle }) => {
  return (
    <AboutUsSectionWrapper id="AboutUsSection">
      <Box className="row" {...row}>
        ...
        <Box className="col" {...col}>
          <Box {...textArea}>
            <FeatureBlock
              title={<Heading content="Great Responsive & Strong Competitive People" {...title} />}
              description={
                <Text
