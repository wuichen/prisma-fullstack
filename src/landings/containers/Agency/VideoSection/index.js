...
import PreviewImage from 'landings/common/src/assets/image/agency/preview-image.jpg';
...
const VideoSection = ({ sectionHeader, sectionTitle, buttonStyle, sectionSubTitle }) => {
  // Video modal handler
