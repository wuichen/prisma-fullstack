...
const BannerSection = ({ row, col, title, btnStyle, description, discountText, discountAmount, outlineBtnStyle }) => {
  const ButtonGroup = () => (
    <Fragment>
      ...
      <Button title="WATCH WORKS" variant="textButton" icon={<i className="flaticon-next" />} {...outlineBtnStyle} />
    </Fragment>
  );
  return (
    <BannerWrapper>
      ...
      <Container>
        <Box className="row" {...row}>
          <Box className="col" {...col}>
            ...
            <FeatureBlock
              title={<Heading content="With Knowledge, Passion, Heart & Soul Agencies" {...title} />}
              description={
                <Text
