...
import TestimonialSectionWrapper, { TextWrapper, ImageWrapper } from './testimonialSection.style';
    ...
    <TestimonialSectionWrapper id="testimonialSection">
      <Container>
        ...
        <GlideCarousel
          ...
          nextButton={
            <Button icon={<i className="flaticon-next" />} aria-label="Next" variant="textButton" {...btnStyle} />
          }
          prevButton={
            <Button icon={<i className="flaticon-left-arrow" />} aria-label="Prev" variant="textButton" {...btnStyle} />
          }
        >
          <Fragment>
