...
import LogoImage from 'landings/common/src/assets/image/agencyDigital/logo.png';
  ...
  return (
    <NavbarWrapper className="agencyModern-navbar navbar">
      <Container width="1440px">
        <Logo href="/agencydigital" logoSrc={LogoImage} title="Agency Digital" className="main-logo" />
        {/* end of logo */}
