...
import { TESTIMONIALS } from 'landings/common/src/data/SaasClassic';
    ...
    <Box {...sectionWrapper} as="section" id="testimonial_section">
      <Container>
        <Box {...secTitleWrapper}>
          ...
          <Heading {...secHeading} content="Meet Client Satisfaction by using product" />
        </Box>
        <TestimonialSlideWrapper>
          <GlideCarousel
                ...
                <GlideSlide key={`testimonial-slide-${index}`}>
                  <TestimonialItem>
                    ...
                    <TestimonialMeta>
                      <AuthorInfo>
                        <AuthorImage>
                          <Image src={item.avatar} alt={`reviewer-image-${index}`} />
                        </AuthorImage>
                        <Box>
