...
import { MONTHLY_PRICING_TABLE, YEARLY_PRICING_TABLE } from 'landings/common/src/data/SaasClassic';
    ...
    <Box {...sectionWrapper} id="pricing_section">
      <Container>
        <Box {...secTitleWrapper}>
          ...
          <Heading {...secHeading} content="Choose your pricing policy which affordable" />
          <PricingButtonWrapper>
            <Button
                    ...
                    <PricingButton>
                      ...
                      {pricingTable.trialButtonLabel ? (
                        <Link href={pricingTable.trialURL || '#'}>
                          <a className="trial_button">{pricingTable.trialButtonLabel}</a>
                        </Link>
                      ) : (
                        ''
                      )}
