...
import { SERVICE_ITEMS } from 'landings/common/src/data/SaasClassic';

const ServiceSection = ({ secTitleWrapper, secText, secHeading, Row, Col, serviceTitleStyle, secDes }) => {
  return (
    <SectionWrapper>
      <Container>
        <Box {...secTitleWrapper}>
          <Text {...secText} content="CUSTOMER SERVICE" />
          <Heading {...secHeading} content="Choose dashboard for every stage of your customer journey" />
          <Text
            {...secDes}
