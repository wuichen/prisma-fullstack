...
import { BannerWrapper, DiscountWrapper, DiscountLabel, VideoModal, PlayButton, VideoWrapper } from './banner.style';
import BannerImage from 'landings/common/src/assets/image/saasClassic/banner-image.jpg';
          ...
          <Box {...contentWrapper}>
            <DiscountWrapper>
              <DiscountLabel>
                ...
                <Text {...discountText} content="for first month trail version" />
              </DiscountLabel>
            </DiscountWrapper>
            <Heading {...title} content="Ultimate Platform to monitor your best workflow." />
            <Text
              {...description}
