...
import GoogleImg from 'landings/common/src/assets/image/app/google.svg';
import AppleImg from 'landings/common/src/assets/image/app/apple.svg';
import DribbleImg from 'landings/common/src/assets/image/app/dribbble.svg';
import MailchimpImg from 'landings/common/src/assets/image/app/mailchimp.svg';
import BackgroundImg from 'landings/common/src/assets/image/app/partner-bg.png';

const PartnerHistory = ({ row, col, cardStyle, title, description, btnStyle, sectionSubTitle, cardArea }) => {
  return (
    <PartnerHistoryWrapper id="partners">
      <Image src={BackgroundImg} className="backgroungImg" alt="backgroungImg" />
      <Container>
