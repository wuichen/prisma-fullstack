...
import CheckBox from 'landings/common/src/components/Checkbox/index';
...
import LogoImage from 'landings/common/src/assets/image/agency/logo.png';
import LoginImage from 'landings/common/src/assets/image/agency/login-bg.jpg';
import GoogleLogo from 'landings/common/src/assets/image/agency/google-icon.jpg';
...
const LoginModal = ({
  ...
  const LoginButtonGroup = () => (
    <Fragment>
      ...
      <Button title="Forget Password" variant="textButton" {...outlineBtnStyle} />
    </Fragment>
  );
          ...
          <Box {...contentWrapper}>
            ...
            >
              <TabPane tab="LOGIN" key="loginForm">
                ...
                <CheckBox id="remember" htmlFor="remember" labelText="Remember Me" />
                <div>
                  <LoginButtonGroup />
                </div>
              </TabPane>
