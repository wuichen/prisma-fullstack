...
import ImageOne from 'landings/common/src/assets/image/app/info1.png';
import ImageTwo from 'landings/common/src/assets/image/app/info2.png';
      ...
      <Container>
        <Box {...row} {...textAreaRow}>
          <Box {...col} {...textArea}>
            ...
            <FeatureBlock
              title={<Heading content="Deploy your site with simple commands" {...title} />}
              description={
                <Text
