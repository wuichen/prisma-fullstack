...
import ImageOne from 'landings/common/src/assets/image/app/mockup.png';
import ImageTwo from 'landings/common/src/assets/image/app/credit-card.png';
      ...
      <Container>
        <Box {...row} {...textAreaRow}>
          <Box {...col} {...textArea}>
            ...
            <FeatureBlock
              title={<Heading content="Secure Payment and Transaction System With #1 ranking" {...title} />}
              description={
                <Text
