...
import LogoImage from 'landings/common/src/assets/image/app/logo.png';

import data from 'landings/common/src/data/App/Footer';

const Footer = ({ row, col, colOne, colTwo, titleStyle, logoStyle, textStyle, copyrightMenu, copyright }) => {
  return (
    <FooterWrapper>
      <Container>
        <Box className="row" {...row}>
          ...
          <Box {...colTwo} className="copyrightClass">
            <Logo href="#" logoSrc={LogoImage} title="App" logoStyle={logoStyle} />
