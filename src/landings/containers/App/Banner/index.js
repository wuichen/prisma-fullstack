...
import BannerWrapper, { DiscountWrapper, DiscountLabel, ButtonWrapper, EmailInputWrapper } from './banner.style';

import AppScreenshot from 'landings/common/src/assets/image/app/mobile.png';
        ...
        <Box {...row}>
          <Box {...col}>
            ...
            <ButtonWrapper>
              ...
              <Link href="#">
                <a>
                  <Button {...button} {...btnStyleTwo} icon={<Icon icon={ic_arrow_forward} />} className="withoutBg" />
                </a>
              </Link>
            </ButtonWrapper>
          </Box>
