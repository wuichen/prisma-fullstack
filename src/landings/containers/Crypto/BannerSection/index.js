...
import BannerBG from 'landings/common/src/assets/image/crypto/white_bg1.svg';
      ...
      <Container>
        <Box className="row" {...row}>
          <Box className="col" {...col}>
            <FeatureBlock
              title={<Heading content="Accounts Payable Automation 80% Faster Bill Pay and AP" {...title} />}
              description={
                <Text
