...
import { PROOFS_FEATURE } from 'landings/common/src/data/Crypto';
import { TrustedWrapper, FeatureSection } from './trustedProof.style';
import AppButton from 'landings/common/src/assets/image/crypto/app.svg';
import PlayButton from 'landings/common/src/assets/image/crypto/playstore.svg';
          ...
          <Box className="colleft" {...col} style={{ flexDirection: 'column' }}>
            ...
            <Fade up>
              <div className="TrustedImageBtn">
                <Link href="#1">
                  <a>
                    <Image src={AppButton} className="app_image_area" alt="App Image" />
                  </a>
                </Link>
                <Link href="#1">
                  <a>
                    <Image src={PlayButton} className="play_image_area" alt="GooglePlay Image" />
                  </a>
                </Link>
              </div>
            </Fade>
