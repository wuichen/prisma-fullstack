...
import { SCALABLE_FEATURE } from 'landings/common/src/data/Crypto';
import { ScalableWrapper, FeatureSection } from './scalable.style';
import ScalableImage from 'landings/common/src/assets/image/crypto/scalable.jpg';
      ...
      <Container noGutter mobileGutter>
        <Box className="row" {...row}>
          ...
          <Box className="colright" {...col} {...cardArea}>
            <Image src={ScalableImage} className="ScalableImage" alt="Scalable Section Image" />
          </Box>
        </Box>
      </Container>
    </ScalableWrapper>
