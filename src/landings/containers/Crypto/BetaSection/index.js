...
import { BETA_FEATURE } from 'landings/common/src/data/Crypto';
import { BetaSectionWrapper, FeatureSection } from './betaSection.style';

const BetaSection = ({ row, title, description, sectionSubTitle, featureTitleStyle, featureDescriptionStyle }) => {
  return (
