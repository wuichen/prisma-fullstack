...
const ContactSection = ({ sectionWrapper, row, contactForm, secTitleWrapper, button, note, title, description }) => {
  return (
    <SectionMainWrapper>
      <Box {...sectionWrapper}>
          ...
          <Box {...row}>
            <Box {...contactForm}>
              ...
              <Box className="contactdes">
                <Text as="span" {...note} content="Become part of our ever growing community. " />
                <Link href="#">
