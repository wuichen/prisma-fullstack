...
import SectionWrapper, { ButtonGroup, PricingArea, InnerWrapper, PricingCard } from './pricingPolicy.style';

import crown from 'landings/common/src/assets/image/appClassic/crown.svg';

import { pricing } from 'landings/common/src/data/AppClassic';
            ...
            {state.pricingPlan.map((item) => (
              <PricingCard key={`${state.active}-card--key${item.id}`}>
                ...
                <div className="card-footer">
                  ...
                  <Button title={item.price === 0 ? 'Start Free Trail' : 'Subscribe Now'} />
                  {item.trail ? (
                    <div className="trail">
