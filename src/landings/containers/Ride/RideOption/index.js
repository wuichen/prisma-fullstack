...
import DriverImage from 'landings/common/src/assets/image/ride/driver-side.svg';
import RiderImage from 'landings/common/src/assets/image/ride/riding-share.svg';
      ...
      <Box {...sectionWrapper} as="section">
        <Container noGutter mobileGutter width="1200px" className="container">
          ...
          <Box {...row}>
            ...
            >
              <Box {...desTitleWrapper} className="desTitleWrapper desTitleWrapperLeft">
                ...
                <Box {...desOnHover} className="desOnHover desOnHoverLeft">
                  <Text {...desDetails} className="desDetailsFirst" content="Ride at any time." />
              ...
              <Image src={RiderImage} className="rider_image_area" alt="Man Image" />
            </Box>
            <Box
              {...col}
              {...col2}
            ...
            >
              <Image src={DriverImage} className="driver_image_area" alt="Driver Image" />
              <Box {...desTitleWrapper} className="desTitleWrapper">
                ...
                <Box {...desOnHover} className="desOnHover ">
                  <Text {...desDetails} className="desDetailsFirst" content="Drive when you want." />
                  <Text {...desDetails} content="Find opportunities around you!" />
                  <Link href="#services">
                    <a className="buttonStyle">
                      <Button title="Learn More" {...button1} />
                    </a>
