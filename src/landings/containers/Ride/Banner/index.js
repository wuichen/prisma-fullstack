...
import CarImage from 'landings/common/src/assets/image/ride/car.png';
import ManImage from 'landings/common/src/assets/image/ride/man.png';
import bannerApp from 'landings/common/src/assets/image/ride/bannerApp.png';
import bannerPlay from 'landings/common/src/assets/image/ride/bannerPlay.png';
      ...
      <Container noGutter mobileGutter width="1200px" className="container">
        <Box {...row}>
          <Box {...contentArea} className="contentArea">
            ...
            <Text content="We’ll send you a text with a link to download the app." {...aboutStyle} />
            <Fade up>
              <div className="bannerImageBtn">
                <Link href="#1">
                  <a>
                    <Image src={bannerApp} className="app_image_area" alt="App Image" />
                  </a>
                </Link>
                <Link href="#1">
                  <a>
                    <Image src={bannerPlay} className="play_image_area" alt="GooglePlay Image" />
                  </a>
                </Link>
              </div>
            </Fade>
