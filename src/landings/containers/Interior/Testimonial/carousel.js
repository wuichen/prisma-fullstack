    ...
    <div className="glide" id="glide_carousel">
      <div className="slide__wrapper">
              ...
              <li className="glide__slide" key={`glide__slide--key${item.id}`}>
                <div className="testimonial_card">
                  <div className="user_info">
                    ...
                    <p>
                      {item.designation} <a href={item.account_url}>{item.username}</a>
                    </p>
                  </div>
        ...
        <div className="glide__arrows" data-glide-el="controls">
          <button className="glide__arrow glide__arrow--left" data-glide-dir="<" aria-label="prev">
            <span className="prev_arrow"></span>
          </button>
          <button className="glide__arrow glide__arrow--right" data-glide-dir=">" aria-label="next">
      ...
      <div className="glide__bullets" data-glide-el="controls[nav]">
        {data.map((item) => (
          <button className="glide__bullet" data-glide-dir={`=${item.id}`} key={`glide_bullet--key${item.id}`}>
