...
import { bannerData } from 'landings/common/src/data/Interior';
        ...
        <ContentArea>
          <Fade bottom delay={30}>
            ...
            <FormWrapper onSubmit={handleSubscriptionForm}>
              ...
              />
              <ButtonGroup>
                <Button type="submit" colors="primaryWithBg" title="FREE CONSULT" />
                <Button title="EXPLORE MORE" variant="textButton" icon={<i className="flaticon-next" />} />
              </ButtonGroup>
            </FormWrapper>
          </Fade>
        </ContentArea>
