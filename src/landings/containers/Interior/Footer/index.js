...
import FooterWrapper, { CurvIcon, List, ListItem, SocialList } from './footer.style';

import { footerData } from 'landings/common/src/data/Interior';
        ...
        <Container width="1330px">
          <Box className="row" {...row}>
            <Box className="col-one" {...colOne}>
              <Logo className="logo" href="/interior" logoSrc={logo} title="Interior" />
          ...
          <Box className="row copyright" {...row}>
            ...
            <p>
              Built & designed with
              <svg xmlns="http://www.w3.org/2000/svg" width="11.243" height="10.378" viewBox="0 0 11.243 10.378">
                <path
                  id="f141"
