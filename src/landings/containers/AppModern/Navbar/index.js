...
import LogoImage from 'landings/common/src/assets/image/appModern/logo-white.png';
import LogoImageAlt from 'landings/common/src/assets/image/appModern/logo.png';

import { navbar } from 'landings/common/src/data/AppModern';
...
const Navbar = () => {
  ...
  return (
    <NavbarWrapper className="navbar">
      <Container>
        <Logo href="/appmodern" logoSrc={LogoImage} title="App Modern" className="main-logo" />
        <Logo href="/appmodern" logoSrc={LogoImageAlt} title="App Modern" className="logo-alt" />
        {/* end of logo */}
