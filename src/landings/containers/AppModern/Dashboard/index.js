...
import DashboardObject1 from 'landings/common/src/assets/image/appModern/dashboard.png';
      ...
      <Container>
        <Box className="row" {...row}>
          <Box className="col" {...col}>
            ...
            <FeatureBlock
              title={<Heading content="Meet the dashboard features of our finalcial management." {...title} />}
              description={
                <Text
