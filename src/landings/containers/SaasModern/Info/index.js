...
import ImageOne from 'landings/common/src/assets/image/saasModern/dash-1.png';
import ImageTwo from 'landings/common/src/assets/image/saasModern/dash-2.png';
  ...
  return (
    <InfoSectionWrapper>
      ...
      <Container>
        <Box {...row} {...textAreaRow}>
          <Box {...col} {...textArea}>
            <Heading {...title} content="Make your website growth with next level visitors" />
            <Text
              {...description}
