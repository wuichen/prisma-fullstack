...
import { FooterWrapper, Newsletter, FooterNav, FooterNavItem } from './footer.style';
import { FOOTER_MENU } from 'landings/common/src/data/Portfolio/data';
import { SOCIAL_PROFILES } from 'landings/common/src/data/Portfolio/data';
  ...
  return (
    <FooterWrapper>
      <Container noGutter mobileGutter width="1200px">
        <Box {...row}>
          <Box {...col}>
            <Heading as="h3" content="So, do we work together?" {...titleStyle} />
            <Link href="#">
              <a>
        ...
        <Box {...row}>
          <Box {...col}>
            <SocialProfile className="footer_social" items={SOCIAL_PROFILES} iconSize={40} />
            <Text as="span" content="© 2018 All rights reserved. " {...copyrightStyle} />
            <Link href="#">
              <a>
                {' '}
