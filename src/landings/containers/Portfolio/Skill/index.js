...
import { SkillItem, SkillDetails, SkillProgress, SuccessRate, ProgressBar, SkillIcon, SkillAbout } from './skill.style';
import { SKILLS } from 'landings/common/src/data/Portfolio/data';
          ...
          {SKILLS.map((item, index) => (
            <Box {...col} key={`skill-item-${index}`}>
              <SkillItem>
                ...
                <SkillProgress>
                  <SuccessRate>
                    <Icon icon={ic_thumb_up} size={12} className="skill_success_icon" />
                    <Text as="span" content={`${item.successRate}% `} {...skillSuccessRate} />
                    <Text as="span" content="Success Rate" {...skillSuccessRate} {...successRateText} />
                  </SuccessRate>
                  <ProgressBar>
                    <Line
