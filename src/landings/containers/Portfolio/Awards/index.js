...
import { AWARDS } from 'landings/common/src/data/Portfolio/data';
  ...
  return (
    <AwardSectionWrapper id="awards_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading {...secTitle} content="Honorable Recognitions &amp; Awards" />
          <Text
            {...secDescription}
          ...
          <>
            {AWARDS.map((award, index) => (
              <GlideSlide key={`award-item-${index}`}>
                <AwardItem>
                  <AwardImageWrapper>
                    <Image src={award.awardLogo} alt={`award-logo-${index}`} {...awardLogoStyle} />
                  </AwardImageWrapper>
                  <Heading content={award.awardName} {...awardNameStyle} />
                  <Text content={award.awardDetails} {...awardDetailsStyle} />
                  <AwardeeWrapper>
                    <AwardeeLogo>
                      <Image src={award.awardeeLogo} alt={`awardee-logo-${index}`} {...awardeeLogoStyle} />
                    </AwardeeLogo>
                    <AwardeeDetails>
                      <Heading content={award.awardeeName} {...awardeeNameStyle} />
