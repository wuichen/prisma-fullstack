...
import { TestimonialWrapper, TestimonialItem, TestimonialHead, TestimonialThumb } from './testimonial.style';
import { TESTIMONIAL } from 'landings/common/src/data/Portfolio/data';
              ...
              {TESTIMONIAL.map((item, index) => (
                <GlideSlide key={`testimonial-item-${index}`}>
                  <TestimonialItem>
                    <TestimonialHead>
                      <TestimonialThumb>
                        <Image src={item.image} alt={`testimonial-avatar-${index + 1}`} />
                      </TestimonialThumb>
                    ...
                    <Text as="span" content={item.designation} {...designationStyle} />
