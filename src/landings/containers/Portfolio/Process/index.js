...
import { PROCESS_STEPS, SERVICE_LIST } from 'landings/common/src/data/Portfolio/data';
  ...
  return (
    <Box {...sectionWrapper} as="section" id="process_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading {...secTitle} content="From Lean Design Sprints to Agile Development" />
          <Text {...secDescription} content="Our process is designed to give you the best shot at success." />
        </Box>
          ...
          {PROCESS_STEPS.map((item, index) => (
            <Box {...processCol} key={`process-item-${index}`} className="process_item_col">
              <ProcessItem className="process_item">
                <Image src={item.image} alt={`process-image-${index + 1}`} {...processImageStyle} />
        ...
        <Box {...learningRow}>
          <Box {...learningContentArea}>
            <Heading content="Which is why we Never Stop Learning." {...learningTitle} />
            <Text content="We believe that we succeed when our clients succeed." {...learningSubTitle} />
            <Text
              {...learningDescription}
            ...
            <Box {...buttonWrapper}>
              ...
              <ButtonWrapper>
                <Button title="hello@redq.io" className="portfolio_button" {...buttonStyle} />
              </ButtonWrapper>
            </Box>
          </Box>
