...
import SectionWrapper, { Section, Content, Illustration } from './customer.style';
import illustration from 'landings/common/src/assets/image/agencyModern/customer.png';
    ...
    <SectionWrapper>
      <Container>
        <Section>
          ...
          <Content>
            <Heading as="h2" content="We have more than thousand of worldwide happy customer" />
